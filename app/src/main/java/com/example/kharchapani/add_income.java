...
public class add_income extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        datechip = view.findViewById(R.id.datechip2);
        dateselect = view.findViewById(R.id.dateselect2);
        add_button = view.findViewById(R.id.add2);
        amount_editText = view.findViewById(R.id.amount);
        categedittext = view.findViewById(R.id.categedittext2);
